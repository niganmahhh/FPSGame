...
This project uses public, redistributable model assets only. No proprietary
CrossFire, Valorant, Counter-Strike, or other commercial FPS game files are
included.

## Poly Pizza / Quaternius Ultimate Guns Pack

- Source: https://poly.pizza/bundle/Ultimate-Guns-Pack-cpgUfI4t2F
- License: Public Domain (CC0)
- Used files:
  - `assault-rifle.glb`
  - `assault-rifle-alt.glb`
  - `sniper-rifle.glb`
